...
/**
 * Created by Sajith Deshappriya on 1/22/2017.
 */
...
public class Bluetooth {
    ...
    //lk.teamiv.pregcare.Constants that indicate the current connection state
    ...
    public synchronized void connected(BluetoothSocket socket,
        ...
        mConnectedThread = new ConnectedThread(socket, socketType,setTemp);
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType,TextView setTemp) {
